...
public enum OrderConditionType {
    ...
    public static OrderConditionType fromInt(int n) {
        for (OrderConditionType i : OrderConditionType.values()) {if (i.val() == n) {return i;}}
    ...
    public static OrderConditionType fromString(String s) {
        for (OrderConditionType i : OrderConditionType.values()) {if (i.name().equalsIgnoreCase(s)) {return i;}}
